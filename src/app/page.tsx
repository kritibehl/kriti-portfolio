    ...
    <div ref={rootRef}>
      ...
      <section className="wrap rev" id="experience">
        ...
        <div className="exp-list">
          {[
            { role: "Graduate Research & Teaching Assistant", dates: "Aug 2024 – Dec 2025", company: "University of Florida · Gainesville, FL", bullets: ["Maintained and debugged a production scheduling system used by ~600–800 students weekly, resolving edge cases in constraint logic and ensuring reliable availability during peak registration periods.","Supported graduate-level coursework in distributed systems and algorithms; held office hours, graded assignments, and provided technical guidance on systems correctness and concurrency."] },
