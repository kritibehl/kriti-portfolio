    ...
    <div ref={rootRef}>
      ...
      <section className="wrap rev" id="experience">
        ...
        <div className="exp-list">
          {[
            { role: "Graduate Assistant", dates: "Aug 2024 – Dec 2025", company: "University of Florida · Gainesville, FL", bullets: ["Maintained and debugged a production scheduling system used by ~600–800 students weekly, resolving edge cases in constraint logic and ensuring reliable availability during peak registration periods."] },
